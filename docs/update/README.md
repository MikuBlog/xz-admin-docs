...
1. 去除无关页面、组件、插件，减轻初始项目大小
2. 修复若干`bug`
3. 更新`Tinymce`富文本编辑器版本，优化使用体验
4. 固定表格高度，降低页面高度，操作更方便快捷
5. 使用`css`样式优化滚动条样式，仅在`Chrome`浏览器生效
6. 优化目录结构
7. 优化若干`api`的实现及使用方式，功能更强大
8. 优化`xz-docs`参数排版
...
11. 优化目录结构
12. 暴露可访问公共页面
13. 更换富文本编辑器,使用`Tinymce`
14. 富文本添加批量上传图片、上传附件、可粘贴上传功能
15. 菜单管理添加页面缓存功能
16. 去除冗余代码
17. 优化所有删除接口
...
2. 添加图表库
3. 修复菜单栏折叠卡顿问题
4. 修复搜索菜单组件在移动端无法调出键盘问题
5. 修复水平菜单无法使用夜间模式问题
6. 修复头像宽度过小问题
7. 修复异常日志查看详情显示内容不换行问题
8. 亮度默认为100且不进行设置（影响部分浏览器的流畅度）
9. 修改错误日志按钮出现逻辑（有`bug`的情况下才会出现）
10. 优化用户体验
